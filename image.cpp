...
int Image::width() volatile const
{
  return m_width;
}

int Image::height() volatile const
{
  return m_height;
}
...
double& Image::operator()(int x, int y, int i) volatile
{
  return m_data[m_elements * (m_width * y + x) + i];
}

bool Image::savePng(const std::string& filename) volatile
{
