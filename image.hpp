...
public:
  ...
  int width() volatile const; ///< Determine the width of the image
  int height() volatile const; ///< Determine the height of the image
  ...
  double operator()(int x, int y, int i) const; ///< Retrieve a
                                               ...
                                               ///from the image.
  double& operator()(int x, int y, int i) volatile;  ///< Retrieve a
                                               ///particular component
                                               ///from the image.
  ...
  bool savePng(const std::string& filename) volatile; ///< Save this image into
                                             ///  the given PNG file
